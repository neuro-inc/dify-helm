...
gen-types-schemas:
	app-types dump-types-schema .apolo/src/apolo_apps_dify DifyAppInputs .apolo/src/apolo_apps_dify/schemas/DifyAppInputs.json
	app-types dump-types-schema .apolo/src/apolo_apps_dify DifyAppOutputs .apolo/src/apolo_apps_dify/schemas/DifyAppOutputs.json
